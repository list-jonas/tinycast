...
enum CalcTimeZone {
    ...
    private static let aliasGroups: [String: [String]] = [
        "UTC": ["utc", "zulu"],
        "GMT": ["gmt"],
        "America/New_York": ["est", "edt", "et", "nyc", "new york city", "boston", "washington", "dc", "miami", "atlanta", "philadelphia", "jfk", "atl", "bos", "mia", "ewr", "iad", "charlotte", "nashville", "orlando", "tampa", "pittsburgh", "cleveland", "cincinnati", "columbus", "baltimore", "raleigh", "indianapolis", "louisville"],
        "America/Chicago": ["cst", "cdt", "ct", "austin", "dallas", "houston", "ord", "dfw", "iah", "minneapolis", "st louis", "kansas city", "milwaukee", "new orleans", "memphis", "oklahoma city", "san antonio"],
        "America/Denver": ["mst", "mdt", "mt", "den", "salt lake city", "albuquerque", "boise"],
        "America/Los_Angeles": ["pst", "pdt", "pt", "la", "sf", "san francisco", "silicon valley", "seattle", "las vegas", "sfo", "lax", "sea", "san diego", "san jose", "portland", "sacramento", "fresno", "oakland"],
        "Europe/Paris": ["cet", "cest", "cdg", "ory", "lyon", "marseille", "toulouse", "nice", "bordeaux", "nantes", "lille", "strasbourg"],
        "Europe/London": ["bst", "ldn", "lhr", "lgw", "manchester", "birmingham", "liverpool", "leeds", "glasgow", "edinburgh", "bristol", "cardiff", "cambridge", "oxford", "belfast"],
        "Asia/Kolkata": ["ist", "kolkata", "bengaluru", "bangalore", "mumbai", "delhi", "new delhi", "chennai", "hyderabad", "bom", "del", "blr", "pune", "ahmedabad", "jaipur", "surat", "lucknow", "kanpur", "nagpur", "goa", "kochi", "indore", "thane", "bhopal", "visakhapatnam", "vizag", "patna", "vadodara", "ghaziabad", "ludhiana", "agra", "nashik", "faridabad", "meerut", "rajkot", "varanasi", "srinagar", "aurangabad", "amritsar", "navi mumbai", "allahabad", "prayagraj", "ranchi", "howrah", "coimbatore", "jabalpur", "gwalior", "vijayawada", "jodhpur", "madurai", "raipur", "chandigarh", "guwahati", "mysore", "mysuru", "gurgaon", "gurugram", "noida", "cochin", "trivandrum", "thiruvananthapuram", "panaji", "dehradun", "udaipur", "pondicherry", "puducherry", "jamshedpur", "bhubaneswar", "cuttack", "siliguri", "dhanbad", "kota", "shimla", "tirupati"],
        "Asia/Tokyo": ["jst", "osaka", "kyoto", "nrt", "hnd", "kix", "yokohama", "nagoya", "sapporo", "fukuoka", "kobe", "hiroshima", "sendai", "okinawa", "nara"],
        ...
        "Europe/Berlin": ["munich", "frankfurt", "hamburg", "cologne", "fra", "muc", "txl", "ber", "hannover", "hanover", "stuttgart", "dusseldorf", "dortmund", "essen", "leipzig", "dresden", "bremen", "nuremberg", "nurnberg", "bonn", "mannheim", "karlsruhe", "freiburg", "munster", "augsburg", "kiel", "koln", "munchen"],
        "Europe/Rome": ["milan", "fco", "mxp", "naples", "turin", "florence", "venice", "bologna", "genoa", "palermo", "verona"],
        "Europe/Madrid": ["barcelona", "bcn", "valencia", "seville", "malaga", "bilbao", "zaragoza"],
        "Europe/Zurich": ["geneva", "zrh", "gva", "basel", "bern", "lausanne", "lucerne", "luzern", "winterthur", "st gallen", "lugano"],
        "Europe/Moscow": ["st petersburg", "svo", "led"],
        "Europe/Kyiv": ["kyiv", "lviv", "odesa"],
        "Asia/Tel_Aviv": ["tel aviv", "tlv"],
        "Asia/Shanghai": ["shenzhen", "beijing", "guangzhou", "pvg", "pek", "chengdu", "tianjin", "wuhan", "xian", "hangzhou", "nanjing", "qingdao", "suzhou", "shenyang", "kunming", "xiamen"],
        "Australia/Melbourne": ["melbourne", "mel"],
        "Australia/Brisbane": ["brisbane", "bne", "gold coast"],
        "Australia/Perth": ["perth", "per"],
        "America/Sao_Paulo": ["rio", "rio de janeiro", "gru", "brasilia", "salvador", "curitiba", "porto alegre", "belo horizonte", "recife"],
        "America/Mexico_City": ["cdmx", "mexico city", "mex", "guadalajara", "puebla"],
        "Europe/Vienna": ["vie", "graz", "salzburg", "linz", "innsbruck", "klagenfurt", "villach", "wels", "st polten", "dornbirn", "bregenz", "wien"],
    ...
    /// Flattened on first use. `TimeZone.abbreviationDictionary` is unusable here: its `BDT` is the
    /// Bangladeshi taka. IATA codes are Foundation-less by nature, and the cities IANA never names
    /// are a curated product choice — see docs/features/calculator.md.
